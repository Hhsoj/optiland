...
' bug because pickup generic path does not support surface group indexing'
lens = optic.Optic()
...
lens.pickups.add(
    ...
    attr_type=f"surface_group.surfaces[1].geometry.coefficients",
    target_surface_idx=2,
)

"seems like surface_group.surfaces[1].geometry.coefficients needs go be indexed like surface_group.surfaces[i].geometry.coefficients in pickup.py"
